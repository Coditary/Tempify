...
std::string optional_string_field(const prebyte::Data::Map &map, const std::string &field_name,
...
bool optional_bool_field(const prebyte::Data::Map &map, const std::string &field_name,
                         const std::filesystem::path &path, const bool default_value, const std::string &prefix = {}) {
    const prebyte::Data *value = find_field(map, field_name);
    if (value == nullptr) {
...
std::set<std::string> optional_string_array_field(const prebyte::Data::Map &map, const std::string &field_name,
                                                  const std::filesystem::path &path, const std::string &prefix = {}) {
    const prebyte::Data *value = find_field(map, field_name);
    if (value == nullptr) {
        return {};

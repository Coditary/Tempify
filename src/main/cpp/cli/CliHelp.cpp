...
void append_section(std::ostringstream &stream, const std::string_view title, const std::vector<std::string> &lines) {
    stream << title << ":\n";
...
void append_table(std::ostringstream &stream, const std::string_view title, const std::vector<HelpRow> &rows) {
    stream << title << ":\n";
    std::size_t width = 0;

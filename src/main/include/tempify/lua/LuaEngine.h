...
public:
    ...
    bool evaluate_condition(const QuestionDefinition& question,
                            const std::map<std::string, std::string>& values) const;
    std::optional<std::string> validate_answer(const QuestionDefinition& question,
                                               const std::string& candidate,
                                               const std::map<std::string, std::string>& values) const;
    std::string export_questions_json(const TemplateManifest& manifest,
                                      bool full = false) const;
    void run_hook(const std::filesystem::path& script_path,

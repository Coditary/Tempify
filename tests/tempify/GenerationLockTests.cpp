...
TEST_CASE(GenerationLock_missing_file_returns_nullopt) {
    const std::filesystem::path path = std::filesystem::temp_directory_path() / "tempify-generation-lock-missing.json";
...
TEST_CASE(GenerationLock_loads_managed_files_and_template_metadata) {
    const std::filesystem::path path = std::filesystem::temp_directory_path() / "tempify-generation-lock-valid.json";
